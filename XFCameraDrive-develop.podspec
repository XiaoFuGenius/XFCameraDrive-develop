...
Pod::Spec.new do |s|
  s.name         = "XFCameraDrive-develop" 		# 项目名称
  s.version      = "1.0.3" 		# 版本号 与 你仓库的 标签号 对应
  s.license      = "MIT" 	 # 开源证书
  s.summary      = "iOS 快捷开发工具包 XFCameraDrive.framework Develop." 	# 项目简介
  s.deprecated = false

  s.homepage     = "https://github.com/XiaoFuGenius/XFCameraDrive-develop" 	# 你的主页
  s.source       = { :git => "https://github.com/XiaoFuGenius/XFCameraDrive-develop.git", :tag => "#{s.version}" } 	# 你的仓库地址
